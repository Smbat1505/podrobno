...
type Props<Value> = Value extends Allowed
    ? OverSelectProps<Value>
    : Required<OverSelectProps<Value>>;

const isAllowed = (v: any): v is Allowed =>
    typeof v === "string" || typeof v === "number";

function OverSelect<Value>({
                               value,
                               onChange,
                               options,
                               mapOptionToLabel,
...
const SelectFruit = () => {
    ...
    return (
        <div>
            ...
            <OverSelect value={selected} onChange={setSelected} options={FRUITS} />
        </div>
    );
};
...
const SelectNumber = () => {
    ...
    return (
        <div>
            ...
            <OverSelect value={n} onChange={setN} options={[0, 1, 2, 3, 5]} />
        </div>
    );
};
